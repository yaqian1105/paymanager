...
<div class="wrapper">
	<div class="content-wrapper">
		...
		<div class="content-title">
			<div class="content-title-left"><img src="../static/images/icon_agent_user_show.png"/>代理商排行榜</div>
		...
		<div class="table-title">
			<div class="table-title-left">代理商流水交易流水排行榜</div>
...
<script type="text/javascript">
		function agentDetail(day){
			var chartData;
			$.ajax({
				url : '${rootPath}/echart/agentDetail',
				type : 'GET',
				async : false,
				data : {
					day : day,
	...
	<script src="${rootPath}/static/index/agent_detail.js" type="text/javascript" charset="utf-8"></script>
<script>
