...
var handleEvns=(function () {
	var transformData=function () {
	  var merchantInfoArr=agentsQuery();
		for (var i=0; i<merchantInfoArr.length;i++) {
			var obj={
			id: i+1,
	        name:"<p>"+merchantInfoArr[i].agentName+"</p><p>"+merchantInfoArr[i].contactName+"</p><p>"+merchantInfoArr[i].phone+"</p>",
					//+"<p>"+merchantInfoArr[i].restaurantName+"</p>",
	...
	$(".form-control").after("<span class='search-btn'>搜索<img src='../static/images/icon_search.png'</span>").css('display','inline-block').prop("placeholder",'请输入代理商名进行搜索');
  }
	return {
